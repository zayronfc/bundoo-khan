/*
  EDIT ONLY THIS FILE when you want to change where the buttons go.
  Keep the NFC card pointing to this landing page.

  Example:
  const MENU_URL = "https://example.com/menu.pdf";
